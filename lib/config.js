...
const ConfigSchema = z.object({
  ...
  inputLimits: z.object({
    ...
    review_code_code: z.number().int().positive(),
    refactor_code_code: z.number().int().positive(),
    batch_content_template: z.number().int().positive(),
  }),
});
...
const DEFAULTS = {
  ...
  inputLimits: {
    ...
    review_code_code: 102400,
    refactor_code_code: 102400,
    batch_content_template: 51200,
  },
};
